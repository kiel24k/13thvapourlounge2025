...
import { useDeleteUser, useGetCustomerList, useGetStaffList, useGetUsersList } from "../../hooks/useUsers";
...
const CustomerList = () => {
    ...
    const { data, isPending, isError, isFetching } = useGetCustomerList(
        page,
        sortOrder,
        sortName,
        search,
        ...
        <section>
            <div className="p-2 overflow-x-auto grid gap-2">
                <div className="flex gap-2 items-center">
                    <span className="font-semibold text-2xl">Customer List</span>
                    {data.total <= 1 ? (
                        <span>({data.total} customer)</span>
                    ) : (
